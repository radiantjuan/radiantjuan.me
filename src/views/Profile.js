                        ...
                        <Row className="align-items-center">
                            <Col lg="6" md="6" className="animate__animated animate__fadeInDown">
                                ...
                                <div className="profile-description">
                                    ...
                                    <p className="mt-3">Driven by a passion for innovation, I have a proven track record of developing user-friendly interfaces and optimizing backend functionalities to enhance overall system performance. Moreover, my experience with version control systems like Git and proficiency in database management on both relational and non-relational databases further bolster my capabilities as a Software Engineer.</p>

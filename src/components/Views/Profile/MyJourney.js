        ...
        <React.Fragment>
            <Col xs={12}>
                <Card className="animate__animated animate__fadeInDown animate__delay-1s">
                    <CardHeader>
                        <h4 className="m-0">
                            Temple and Webster - <span className="text-primary">Full-stack Engineer</span>
                        </h4>
                        <p>
            ...
            <Col xs={12}>
                <Card className="animate__animated animate__fadeInDown animate__delay-1s">
                    <CardHeader>
                        <h4 className="m-0">
                            HungryHungry  - <span className="text-primary">PHP Developer</span>
                        </h4>
                        <p>
            ...
            <Col xs={12}>
                <Card className="animate__animated animate__fadeInDown animate__delay-1s">
                    ...
                    <CardBody>
                        <p>
                            Affinity X is a Marketing and Design Company, My role as a web developer is to create mostly an email marketing, and create website occationally using wordpress, yola, joomla and drupal.
                        </p>
                    </CardBody>
                </Card>
            </Col>
